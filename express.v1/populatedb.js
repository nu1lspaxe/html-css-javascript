...
console.log(
  'This script populates some test books, authors, genres and bookinstances to your database. Specified database as argument - e.g.: node populatedb "mongodb+srv://<mongodbUser>:<mongodbPassword>@cluster0.lz91hw2.mongodb.net/local_library?retryWrites=true&w=majority"'
);
...
const mongoDB = userArgs[0]; // mongodb link
...
async function authorCreate(index, first_name, last_name, date_of_birth) {
...
async function createGenres() {
  ...
  await Promise.all([
    ...
    genreCreate(1, "Sci-Fi"),
    genreCreate(2, "Historoy"),
    genreCreate(3, "Tragedy"),
    genreCreate(4, "Humor"),
...
async function createAuthors() {
  ...
  await Promise.all([
    ...
    authorCreate(4, "Jim", "Jones", false),
  ]);
}
